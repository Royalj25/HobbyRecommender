# 🖥️ Sample Program Run — Hobby Recommender

This file shows a **sample run** of the `HobbyRecommender` program, including example inputs and the **Recommended Hobby** based on your interests.
...
## Example 3 — Indoor, Technical, Programming 💻
Welcome to the Hobby Recommender!
...
## Example 4 — Outdoor, Thrilling, Go-Karting 🏎️
Welcome to the Hobby Recommender!
